...
const CounterWithUseReducer = () => {
  const initialValue = { counterA: 0, counterB: 0 };
  ...
  return (
    <>
      ...
      <button
        ...
        onClick={() => dispatch({ type: "decreament_A" })}
      >
        -A
      </button>
      ...
      <button
        ...
        onClick={() => dispatch({ type: "decreament_B" })}
      >
        -B
      </button>
      <button onClick={() => dispatch({ type: "incremnet_B" })}>+B</button>{" "}
      <br /> <br />
      <button onClick={() => dispatch({ type: "resetBoth" })}>
        Reset Both
      </button>
    </>
  );
